...
{
    public class csshprpg_admincommands
    {
        ...
        public csshprpg_admincommands()
        {
            admins = Admin.LoadAdminsFromDatabase(connectionString);
        }

        private bool IsClientAdmin(CCSPlayerController? Client)
        {
            if (Client != null)
            {
        ...
        [ConsoleCommand("sm_rpgadmin")]
        public Action Cmd_OpenRPGAdminMenu(CCSPlayerController? player, CommandInfo command)
        {
            if (!client)
            {
        ...
        [ConsoleCommand("smrpg_resetstats")]
        ...
        [ConsoleCommand("smrpg_setcredits")]
        ...
        [ConsoleCommand("smrpg_addcredits")]
        ...
        [ConsoleCommand("smrpg_listupgrades")]
        ...
        [ConsoleCommand("smrpg_setupgradelvl")]
        ...
        [ConsoleCommand("smrpg_giveupgrade")]
        ...
        [ConsoleCommand("smrpg_takeupgrade")]
        ...
        [ConsoleCommand("smrpg_buyupgrade")]
        ...
        [ConsoleCommand("smrpg_sellupgrade")]
        ...
        [ConsoleCommand("smrpg_db_delplayer")]
        ...
        [ConsoleCommand("smrpg_db_mass_sell")]
        ...
        [ConsoleCommand("smrpg_reload_weaponexperience")]
        ...
        [ConsoleCommand("smrpg_debug_playerlist")]
         ...
         * SQL callbacks
         */
        public void SQL_CheckDeletePlayer(Database db, DBResultSet results, char[] error, DataPack data)
{
	data.Reset();
...
public void SQL_MassDeleteItem(Database db, DBResultSet results, char[] error, DataPack data)
{
    data.Reset();
    int client = data.ReadCell();
...
public void SQL_PrintPlayerStats(Database db, DBResultSet results, char[] error, DataPack data)
{
    data.Reset();
...
public void SQL_PrintUpgradeStats(Database db, DBResultSet results, char[] error, DataPack data)
{
    data.Reset();
...
public void SQL_PrintUpgradeUsage(Database db, DBResultSet results, char[] error, DataPack data)
{
    data.Reset();
    int client = GetClientFromSerial(data.ReadCell());
    ReplySource source = view_as<ReplySource>(data.ReadCell());
...
stock int FindClientBySteamID(char[] sSteamID)
{
    char sTemp[64];
    for (int i = 1; i <= MaxClients; i++)
    {
...
stock int FindClientByExactName(char[] sName)
{
