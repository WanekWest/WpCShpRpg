...
{
    internal class csshprpg_settings
    {
        ...
        public void SQL_ReadSettings(Database db, DBResultSet results, char[] error, any data)
{
	if(results == null)
	{
...
bool GetSetting(char[] sKey, char[] sValue, int maxlen)
{
    return g_hSettings.GetString(sKey, sValue, maxlen);
}

void SetSetting(char[] sKey, char[] sValue)
{
    g_hSettings.SetString(sKey, sValue);
    char sQuery[512];
